...
VkDescriptorPool DescriptorManager::CreateDescriptorPool(SwapChain *swapChain)
{
...
std::vector<VkDescriptorSet> DescriptorManager::CreateDescriptorSets(std::vector<Mesh*> &meshes)
{
